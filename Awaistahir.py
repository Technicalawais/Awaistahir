...
\033[1;94m ┈┈┈▕▕A4 T4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕A4 T4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94Awaistahir.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
...
\033[1;91m☞ Auther     : A4_AWAIS_T4_TAHIR

\033[1;92m☞ WhatsApp   : +79398004250

\033[1;95m☞ YouTube    : https://youtube.com/channel/UCMXCoRzPV3q7bHtllq9iA1Q
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCMXCoRzPV3q7bHtllq9iA1Q)
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update A4_AWAIS Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' A4_AWAIS WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/A4_AWAIS')

	    os.system('cd $HOME && git clone https://github.com/technical hashmi/Awaistahir')
	    ...
	    psb('WhatsApp Num +79398004250✓')

	    psb('WellCome To A4_AWAIS TOOL')

	    psb('Congratulations A4_AWAIS Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ 786786✓')

	    psb('🔓Password ☆ 786786✓')

	    psb('Subscrib My Youtube Channel Technical Hashmi✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/A4_AWAIS && python2 awais.py')
